;for easySNES
;some of the macros are from Damian Yerrick
...
;address of a tile, use this, then add it to the base vram address
.define TILE_OFFSET(xc,yc) ((xc)|((yc)<<5))

;value of a palette color 0-$7fff
;5 bits each b,g,r should all be 0-31 (0-$1f)
...
;for bg3_priority or SET_BG3_PRI
BG3_BOTTOM = 0	
BG3_TOP = 8



;for bg1_map_size or SET_BG1_MAP_SIZE etc.
MAP_32_32 = 0
MAP_64_32 = 1
MAP_32_64 = 2
MAP_64_64 = 3
...
;for bg_tilesize or SET_BG_TILESIZE
BG_ALL_8x8 = 0
BG1_16x16 = $10
BG2_16x16 = $20
BG3_16x16 = $40
...
;for vram_inc or SET_VRAM_INC
;and increment after the vram write
;register 2115
V_INC_1 = $80
V_INC_32 = $81
...
;for set_main_screen and set_sub_screen
SCREEN_OFF = 0
BG1_ON = 1
BG2_ON = 2
BG3_ON = 4
...
;for interrupts controller 4200, SET_INTERRUPT
...
;bg1_scroll_y = $210e
;0d 0e also mode 7 scroll registers
